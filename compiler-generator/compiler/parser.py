...
PARSE_TABLE = {'Lang': {TokenType.TOKEN_IGNORE_FLAG: RULES["Lang"][0], TokenType.ID: RULES["Lang"][0], TokenType.SEP: RULES["Lang"][0], TokenType.EOF: RULES["Lang"][0]}, 'Tokens': {TokenType.TOKEN_IGNORE_FLAG: RULES["Tokens"][0], TokenType.ID: RULES["Tokens"][0], TokenType.SEP: RULES["Tokens"][1]}, 'Token': {TokenType.TOKEN_IGNORE_FLAG: RULES["Token"][0], TokenType.ID: RULES["Token"][0], TokenType.SEMICOLON: RULES["Token"][0]}, 'TokenModifiers': {TokenType.TOKEN_IGNORE_FLAG: RULES["TokenModifiers"][0], TokenType.ID: RULES["TokenModifiers"][1]}, 'Grammar': {TokenType.ID: RULES["Grammar"][0], TokenType.EOF: RULES["Grammar"][1]}, 'Rule': {TokenType.ID: RULES["Rule"][0]}, 'RuleResult': {TokenType.PIPE: RULES["RuleResult"][0], TokenType.SEMICOLON: RULES["RuleResult"][1]}, 'SingleRuleResult': {TokenType.EPSILON: RULES["SingleRuleResult"][0], TokenType.TOKEN_NAME: RULES["SingleRuleResult"][0], TokenType.ID: RULES["SingleRuleResult"][0], TokenType.ACTION: RULES["SingleRuleResult"][0]}, 'VariableCombinations': {TokenType.EPSILON: RULES["VariableCombinations"][0], TokenType.TOKEN_NAME: RULES["VariableCombinations"][0], TokenType.ID: RULES["VariableCombinations"][0], TokenType.ACTION: RULES["VariableCombinations"][0], TokenType.PIPE: RULES["VariableCombinations"][1], TokenType.SEMICOLON: RULES["VariableCombinations"][1]}, 'VariableCombination': {TokenType.EPSILON: RULES["VariableCombination"][0], TokenType.TOKEN_NAME: RULES["VariableCombination"][1], TokenType.ID: RULES["VariableCombination"][2], TokenType.ACTION: RULES["VariableCombination"][3]}}
